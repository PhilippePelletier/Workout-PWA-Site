const CACHE_NAME = 'workout-pwa-compact-v6-1756500960';
const ASSETS = [
...
self.addEventListener('activate', e=>e.waitUntil((async()=>{
  ...
  await Promise.all(keys.filter(k=>k.startsWith('workout-pwa-compact-v6-') && k!==CACHE_NAME).map(k=>caches.delete(k)));
