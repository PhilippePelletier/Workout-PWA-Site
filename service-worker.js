const CACHE_NAME = 'workout-pwa-compact-v5-1756500131';
const ASSETS = [
...
self.addEventListener('activate', e=>e.waitUntil((async()=>{
  ...
  await Promise.all(keys.filter(k=>k.startsWith('workout-pwa-compact-v5-') && k!==CACHE_NAME).map(k=>caches.delete(k)));
