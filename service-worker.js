const CACHE_NAME = 'workout-pwa-compact-v7-1756501603';
const ASSETS = [
...
self.addEventListener('activate', e=>e.waitUntil((async()=>{
  ...
  await Promise.all(keys.filter(k=>k.startsWith('workout-pwa-compact-v7-') && k!==CACHE_NAME).map(k=>caches.delete(k)));
